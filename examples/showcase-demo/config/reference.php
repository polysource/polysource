 ...
 * }
 * @psalm-type PolysourceConfig = array{
 ...
 * }
 * @psalm-type PolysourceEasyadminFilterBridgeConfig = array{
 *     auto_register_routes?: bool|Param, // Auto-import bridge routes via Bundle::boot(). Set to false on multi-tenant hosts where EA is mounted under a custom prefix (e.g. `/{channel}/admin`) and import `@PolysourceEasyAdminFilterBridge/config/routes.php` manually from `config/routes.yaml` under your own prefix. // Default: true
 * }
 ...
 *     resource_slug?: scalar|Param|null, // URL slug for the failed-messages resource. // Default: "failed-messages"
 *     payload_max_bytes?: int|Param, // Maximum serialized payload size before truncation. // Default: 50000
 *     max_retry_all?: int|Param, // Maximum envelopes processed by a single retry-all click. Cap exists so a runaway transport cannot saturate the worker pool. // Default: 1000
 *     max_purge?: int|Param, // Maximum envelopes acked by a single purge-all click. // Default: 1000
 * }
 * @psalm-type PolysourceWorkflowBridgeConfig = array{
 *     palettes?: array<string, array<string, scalar|Param|null>>,
 * }
 ...
 *     polysource?: PolysourceConfig,
 *     polysource_easyadmin_filter_bridge?: PolysourceEasyadminFilterBridgeConfig,
 *     polysource_messenger?: PolysourceMessengerConfig,
 *     polysource_workflow_bridge?: PolysourceWorkflowBridgeConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
